    ...
    <div className="bg-offwhite/5 border border-offwhite/10 p-[26px] rounded-none">
      <div className="flex justify-between items-center mb-[18px]">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={cn(
              'w-7 h-7 border border-offwhite/10 text-offwhite/55 text-[13px]',
      ...
      <div className="grid grid-cols-7 gap-[3px] mb-[5px]" aria-hidden="true">
        {['D','S','T','Q','Q','S','S'].map((d, i) => (
          <span key={i} className="text-center font-body font-light text-[8.5px] tracking-[0.15em] uppercase text-offwhite/55 py-[5px]">
            {d}
          </span>
        ))}
      </div>
      ...
      {loading && (
        <p className="text-center font-body font-light text-[8px] tracking-[0.24em] uppercase text-offwhite/55 mt-3">
