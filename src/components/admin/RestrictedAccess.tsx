  ...
  return (
    <div className="p-8">
      <div className="max-w-[420px] mx-auto mt-[80px] text-center bg-offwhite/5 border border-offwhite/[0.07] p-10">
        <p className="font-body font-light text-[8px] tracking-[0.38em] uppercase text-offwhite/55 mb-4">
        ...
        <p className="font-body font-light text-[12px] text-offwhite/55 leading-[1.6]">
