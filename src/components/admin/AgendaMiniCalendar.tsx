    ...
    <>
      ...
      <div className="md:hidden">
        <button
          ...
          className="px-3 h-[36px] border border-offwhite/[0.14] font-body font-light text-[10px] text-offwhite/60 flex items-center gap-2 hover:border-gold/40 transition-colors"
        >
